...
float FuzzySet::getPointA() { return this->a; }

// Method to get the value of point B
float FuzzySet::getPointB() { return this->b; }

// Method to get the value of point C
float FuzzySet::getPointC() { return this->c; }

// Method to get the value of point D
float FuzzySet::getPointD() { return this->d; }
...
float FuzzySet::getPertinence() { return this->pertinence; }

// Method to reset the value of pertinence
void FuzzySet::reset() { this->pertinence = 0.0; }