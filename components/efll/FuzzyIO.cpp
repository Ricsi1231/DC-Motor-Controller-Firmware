...
// DESTRUCTOR
FuzzyIO::~FuzzyIO() { this->cleanFuzzySets(this->fuzzySets); }

// PUBLIC METHODS

// Method to get the value of index
int FuzzyIO::getIndex() { return this->index; }

// Method to set the value of crispInput
void FuzzyIO::setCrispInput(float crispInput) { this->crispInput = crispInput; }

// Method to get the value of crispInput
float FuzzyIO::getCrispInput() { return this->crispInput; }
