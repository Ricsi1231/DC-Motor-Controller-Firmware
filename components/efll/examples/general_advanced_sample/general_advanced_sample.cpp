...
int main(int argc, char* argv[]) {
    ...
    cout << "Input: \n\tDistance: Near-> " << near->getPertinence() << ", Safe->" << safe->getPertinence() << ", Distant-> " << distant->getPertinence()
         << endl;
    cout << "\tSpeed: Stoped-> " << stopedInput->getPertinence() << ",  Slow-> " << slowInput->getPertinence() << ",  Normal-> " << normalInput->getPertinence()
         << ",  Quick-> " << quickInput->getPertinence() << endl;
    ...
    cout << "Output: \n\tRisk: Minimum-> " << minimum->getPertinence() << ", Average->" << average->getPertinence() << ", Maximum-> "
         << maximum->getPertinence() << endl;
    cout << "\tSpeed: Stoped-> " << stopedOutput->getPertinence() << ",  Slow-> " << slowOutput->getPertinence() << ",  Normal-> "
         << normalOutput->getPertinence() << ",  Quick-> " << quickOutput->getPertinence() << endl;
