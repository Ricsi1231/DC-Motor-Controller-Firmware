 ...
 * @brief Generic PID controller class with anti-windup, derivative filtering, and auto-settle detection.
 *
 * This class computes PID output from a target setpoint and actual feedback input.
 * It supports advanced features like integral clamping, derivative filtering, and stability detection.
 */
...
/**
 * @class PIDController
 * @brief Implements a discrete PID controller with smoothing, clamping, and settle detection.
 */
class PIDController {
public:
  /**
