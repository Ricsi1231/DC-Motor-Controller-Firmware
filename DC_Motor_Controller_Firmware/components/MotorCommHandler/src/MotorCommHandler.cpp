    ...
    namespace Communication {
        ...
        void MotorCommHandler::parseMessage(const char* msg) {
            ...
            if(strncmp(msg, MSG_SET_DEG, strlen(MSG_SET_DEG)) == 0) {
                ...
                snprintf(msg, sizeof(msg), "STATE: DEG=%.2f PID=%.2f,%.2f,%.2f ENABLED=%d STOP=%d\n",
        ...
        void MotorCommHandler::clearStopFlag(bool stopRequested) { this->stopRequested = stopRequested; }
